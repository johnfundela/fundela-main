    ...
    <>
      ...
      <div className="p-2 flex justify-center 2xl:py-10">
        <div className="2xl:w-6/12 text-lg">
          ...
          <p className="my-4 font-semibold">Personally Identifiable Information (PII):</p>
          ...
          <p className="my-4 font-semibold">Non-Personally Identifiable Information (Non-PII):</p>
          <ul className="list-disc list-inside mb-4">
            <li>IP address</li>
          ...
          <p className="my-4">We may share your information with third parties under the following circumstances:</p>
          <ul className="list-disc list-inside mb-4">
          ...
          <p className="my-4">We may use cookies, web beacons, and similar technologies to:</p>
          <ul className="list-disc list-inside mb-4">
            <li>Improve your experience on our Site</li>
            <li>Provide relevant content or ads</li>
            <li>Analyze usage patterns</li>
          </ul>
          <p className="my-4">You can manage your cookie preferences through your browser settings.</p>

          <p className="font-bold">5. Data Security</p>
          <p className="my-4">We implement reasonable administrative, technical, and physical safeguards to protect your data. However, no method of internet transmission or electronic storage is 100% secure.</p>

          <p className="font-bold">6. Your Rights & Choices</p>
          <p className="my-4">Depending on your jurisdiction, including California, you may have rights regarding your personal information:</p>
          <ul className="list-disc list-inside mb-4">
          ...
          <p className="my-4">To exercise these rights, contact us at: <a href="mailto:emails@fundela.com">emails@fundela.com</a></p>
          ...
          <p className="my-4">Our Site may link to third-party websites. We are not responsible for the privacy practices or content of those sites. We encourage you to read their policies.</p>

          <p className="font-bold">9. Children’s Privacy</p>
          <p className="my-4">Our services are not intended for children under 13. We do not knowingly collect personal data from children.</p>

          <p className="font-bold">10. Updates to This Policy</p>
          <p className="my-4">We may update this Privacy Policy periodically. Any changes will be reflected by the "Last Updated" date at the top. Continued use of our services after updates constitutes acceptance.</p>

          <p className="font-bold">11. Contact Us</p>
          <p className="my-4">For questions about this Privacy Policy or your data rights, email us at: <a href="mailto:emails@fundela.com">emails@fundela.com</a></p>
        </div>
      </div>
      <div>
        <ContactUsForm />
