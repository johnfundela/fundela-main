      ...
      <div className="p-2 flex justify-center 2xl:py-10">
        <div className="2xl:w-6/12 text-lg">
          ...
          <p className="my-4">
            ...
            This includes your name, email, address, phone number, and any other details you directly provide, even through a text message.
          </p>
          <p className="my-4">
            <span className="font-semibold">Non-Personally Identifiable Information (Non-PII): </span>
            Technical data like your IP address, browser, device details, website usage, including how you use our text messaging.
          </p>
          ...
          <p className="my-4">
            If you have questions about this policy or our data practices related to text messaging, contact us at: emails@fundela.com
          </p>
        </div>
      </div>
      <div>
